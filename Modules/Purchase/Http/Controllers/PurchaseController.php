...
class PurchaseController extends Controller
{
    ...
    public function store(StorePurchaseRequest $request) {
        // Memeriksa apakah cart kosong atau ada field yang tidak diisi
        if (Cart::instance('purchase')->count() == 0 || !$request->supplier_id || !$request->date || !$request->total_amount || !$request->paid_amount || !$request->status) {
            toast('Please fill all the required fields and add products to the purchase.', 'error');
