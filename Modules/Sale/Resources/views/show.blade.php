            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-4 mb-3 mb-md-0">
                            <h5 class="mb-2 border-bottom pb-2">Table Info:</h5>
                            <div><strong>{{ $customer->customer_name }}</strong></div>
                            <div>Tables Capacity: {{ $customer->customer_phone }}</div>
                            <div>Description: {{ $customer->address }}</div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-5 ml-md-auto">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="left"><strong>Discount ({{ $sale->discount_percentage }}%)</strong>
                                        </td>
