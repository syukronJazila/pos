    ...
    <script>
        $(document).ready(function () {
            $('#product_cost').maskMoney({
                ...
                allowZero: true, // Izinkan tampilan awal sebagai "Rp0"
                affixesStay: true
            });
            ...
            // Atur ulang nilai ke "Rp0" jika kosong
            $('#product_cost, #product_price').each(function() {
                if (!$(this).val()) {
                    $(this).val('Rp0');
                }
            });
            ...
            $('#product-form').submit(function (e) {
                ...
                // Ambil nilai unmasked dari maskMoney dan pastikan formatnya benar
                var product_cost = $('#product_cost').maskMoney('unmasked')[0] * 1000;
                var product_price = $('#product_price').maskMoney('unmasked')[0] * 1000;
            
                // Atur nilai kembali ke dalam input dalam format yang benar
