...
class QuotationController extends Controller
{
    ...
    public function store(StoreQuotationRequest $request) {
        // Validasi manual jika Cart kosong atau field lainnya kosong
        if (Cart::instance('quotation')->count() == 0 || !$request->customer_id || !$request->date || !$request->status) {
            toast('Please fill all the required fields and add products to the quotation.', 'error');
