<div>
                    ...
                    <form wire:submit="generateReport">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                <button type="button" class="btn btn-primary" wire:click="setTodayRange">
                                    Hari Ini
                                </button>
                                <button type="button" class="btn btn-primary" wire:click="setThisMonthRange">
                                    Bulan Ini
                                </button>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h4 style="margin-bottom: 3vh">Total Pendapatan: {{ format_currency($total_pendapatan) }}</h4>
