        ...
        <div class="card-body">
            ...
            <div class="row position-relative">
                <div wire:loading.flex class="col-12 position-absolute justify-content-center align-items-center"
                    style="top:0;right:0;left:0;bottom:0;background-color: rgba(255,255,255,0.5);"
                    wire:loading.style="z-index: 99;" wire:loading.remove.style="z-index: unset;">
                ...
                <div wire:click.prevent="selectProduct({{ $product }})" class="col-lg-4 col-md-6 col-xl-3"
                    style="cursor: pointer;" onclick="Livewire.emit('selectProduct', {{ $product->id }})">
